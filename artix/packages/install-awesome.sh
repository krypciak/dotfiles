...
function install_awesome() {
    ...
    echo 'alacritty awesome breeze breeze-gtk breeze-icons dmenu feh lxappearance qt5-base qt6-base unclutter-xfixes-git xbindkeys xdg-desktop-portal xdotool xkeyboard-config xorg-server xorg-xinit xorg-xprop xorg-xrandr zenity copyq xorg-xmodmap redshift scrot topgrade xdg-utils gtk2 gtk3 qt5ct kolourpaint mpv tutanota-desktop-bin world/gnome-keyring aerc pandoc-bin checkupdates+aur'
