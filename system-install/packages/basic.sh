...
arch_basic_install() {
    ...
    eco 'clang dog dust dysk fd fish fzf htop hyperfine imagemagick'
    echo 'innoextract jq lazygit lsd man-db man-pages moreutils neofetch'
    echo 'neovim-symlinks net-tools nodejs ouch p7zip paru-bin pastel'
    echo 'pipr-bin pnpm procs pv pyright ripgrep rmtrash syntax-highlighting'
    echo 'tealdeer tgpt-bin tmux tokei trash-cli ttf-nerd-fonts-symbols ttyper'
