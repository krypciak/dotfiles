...
# PACKAGE_GROUPS="$PACKAGE_GROUPS awesome"
PACKAGE_GROUPS="$PACKAGE_GROUPS wayland"
PACKAGE_GROUPS="$PACKAGE_GROUPS hyprland"
PACKAGE_GROUPS="$PACKAGE_GROUPS dev-ai"
PACKAGE_GROUPS="$PACKAGE_GROUPS dev-js"
