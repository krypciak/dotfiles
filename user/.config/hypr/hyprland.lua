...
hl.bind('ALT + SHIFT + Tab', hl.dsp.window.move { workspace = '1', follow = false })
hl.bind('ALT + SHIFT + Q', hl.dsp.window.move { workspace = '2', follow = false })
hl.bind('ALT + SHIFT + W', hl.dsp.window.move { workspace = '3', follow = false })
hl.bind('ALT + SHIFT + E', hl.dsp.window.move { workspace = '4', follow = false })
hl.bind('ALT + SHIFT + N', hl.dsp.window.move { workspace = '5', follow = false })
hl.bind('ALT + SHIFT + D', hl.dsp.window.move { workspace = '6', follow = false })
hl.bind('ALT + SHIFT + S', hl.dsp.window.move { workspace = '7', follow = false })
hl.bind('ALT + SHIFT + A', hl.dsp.window.move { workspace = '8', follow = false })
hl.bind('ALT + SHIFT + Z', hl.dsp.window.move { workspace = '9', follow = false })
hl.bind('ALT + SHIFT + C', hl.dsp.window.move { workspace = '10', follow = false })
hl.bind('ALT + SHIFT + H', hl.dsp.window.move { workspace = '11', follow = false })

hl.bind('ALT + CTRL + SHIFT + Tab', hl.dsp.window.move { workspace = '1', follow = true })
hl.bind('ALT + CTRL + SHIFT + Q', hl.dsp.window.move { workspace = '2', follow = true })
hl.bind('ALT + CTRL + SHIFT + W', hl.dsp.window.move { workspace = '3', follow = true })
hl.bind('ALT + CTRL + SHIFT + E', hl.dsp.window.move { workspace = '4', follow = true })
hl.bind('ALT + CTRL + SHIFT + N', hl.dsp.window.move { workspace = '5', follow = true })
hl.bind('ALT + CTRL + SHIFT + D', hl.dsp.window.move { workspace = '6', follow = true })
hl.bind('ALT + CTRL + SHIFT + S', hl.dsp.window.move { workspace = '7', follow = true })
hl.bind('ALT + CTRL + SHIFT + A', hl.dsp.window.move { workspace = '8', follow = true })
hl.bind('ALT + CTRL + SHIFT + Z', hl.dsp.window.move { workspace = '9', follow = true })
hl.bind('ALT + CTRL + SHIFT + C', hl.dsp.window.move { workspace = '10', follow = true })
hl.bind('ALT + CTRL + SHIFT + H', hl.dsp.window.move { workspace = '11', follow = true })
