...
cliphist list | fuzzel --width 100 -d --log-level=none | cliphist decode | wl-copy
exit

# https://github.com/danielwerg/cliphist/blob/master/contrib%2Fcliphist-fuzzel-img
...
item=$(echo "$cliphist_list" | gawk "$thumbnail" | fuzzel --width 100 -d --placeholder "Search clipboard..." --counter --no-sort --with-nth 2)
exit_code=$?
